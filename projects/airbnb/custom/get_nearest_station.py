...
station = (
    station.drop_duplicates(subset=["longitude", "latitude"])
    .drop_duplicates(subset=["station_name"])
    .reset_index(drop=True)
)
station = station.rename(columns={"longitude": "sta_longitude", "latitude": "sta_latitude"})
...
hoge[["id", "station_name", "sta_longitude", "sta_latitude", "dist_from_station"]].to_csv(
    "data/nearest_station_test.csv", index=False
)
