"""mainスクリプト."""
import pandas as pd
from custom.feature_generators import MinNightsAvailability, PreprocessName, ReviewedMonth, RulebaseName
...
trainer_factory_settings = {"model_str": trainer_str, "params": {"target_col": target_col, "seed": seed}}

folds_gen_factory_settings = {
    "model_str": "group",  # kfold, stratified, group, stratified_group
    "params": {"fold_num": fold_num, "seed": seed, "target_col": "y", "key_col": "host_id"},
}

model_factory_settings = {"model_str": "lgbm_rmsle", "params": {"depth": 5, "n_estimators": 100000, "seed": seed}}
...
settings = [
    ...
    },
    {
        ...
        "params": {
            ...
            "feature_generators": [
                ...
                {
                    "model_str": "dec",
                    "params": {"decomposer_str": "pca", "n_components": 20, "random_state": 42, "col_mark": "bert"},
                },
            ],
        },
    },
    {
        ...
        "params": {
            ...
            "feature_generators": [
                ...
                {
                    "model_str": "dec",
                    "params": {"decomposer_str": "umap", "n_components": 10, "random_state": 42, "col_mark": "bert"},
                },
            ],
        },
    },
    {
        "model_str": "pipeline",
        "params": {"feature_generators": [{"model_str": "preprocess_name"}, {"model_str": "rulebase_name"}]},
    },
    # 駅関連
    ...
    {
        "model_str": "cluster",
        "params": {"input_cols": ["latitude", "longitude"], "model_str": "gmm", "n_clusters": 10, "random_state": 42},
    },
    {
        "model_str": "cluster",
        "params": {
        ...
        "params": {
            "feature_generators": [
                {"model_str": "extra_join", "params": {"csv_path": "data/nearest_station.csv", "join_on": "id"}},
                {
                    "model_str": "cluster",
                    "params": {
                        "input_cols": ["sta_latitude", "sta_longitude"],
                        "model_str": "kmeans",
                        "n_clusters": 10,
                        "random_state": 42,
                    },
            ...
            "feature_generators": [
                {"model_str": "extra_join", "params": {"csv_path": "data/nearest_station.csv", "join_on": "id"}},
                {
                    ...
                    "params": {
                        ...
                        "input_cols": ["minimum_nights", "number_of_reviews", "availability_365"],
                    },
                },
                {
                    "model_str": "dec",
...
blocks_runner = BlocksRunner(
    target_col=target_col,
    features_dir=features_dir,
    register_from=register_from,
    features_settings=settings,
