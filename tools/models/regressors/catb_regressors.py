from tools.models.model_base import RegressorBase
from tools.models.base.catb_base import _CatbRegressor, _CatbRmsleRegressor
...
class CatbRmseRegressor(RegressorBase):
    ...
    def __init__(self, target_col, early_stopping_rounds=100, n_estimators=2000, depth=5, seed=None, learning_rate=0.1,
                 random_strength=1, bagging_temperature=0.1, od_type="IncToDec", od_wait=10):
