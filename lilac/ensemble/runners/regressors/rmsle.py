"""RMSLE用の回帰アンサンブル."""
from lilac.ensemble.ensemble_runner_base import EnsembleRunnerBase, LrRmsleEnsembleRunnerBase
...
class LinearRmsleEnsemble(LrRmsleEnsembleRunnerBase):
    ...
    def __init__(
        ...
        model_params = {"model_str": "linear_rmsle"}
        evaluator_flag = "rmsle"
        super().__init__(
            target_col,
            unused_cols,
...
class RidgeRmsleEnsemble(LrRmsleEnsembleRunnerBase):
    ...
    def __init__(
        ...
        model_params = {"model_str": "ridge_rmsle"}
        evaluator_flag = "rmsle"
        super().__init__(
            target_col,
            unused_cols,
