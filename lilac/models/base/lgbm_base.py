...
class _LgbmBase:
    ...
    def fit(self, train_x, train_y, valid_x, valid_y):
        ...
        train_x_cat = self.encoder.fit_transform(
            train_x[self.object_cols]).add_suffix("_enc")
        valid_x_cat = self.encoder.transform(
            valid_x[self.object_cols]).add_suffix("_enc")
...
class _LgbmClassifier(_LgbmBase):
    ...
    def predict_proba(self, test):
        test_cat = self.encoder.transform(
            test[self.object_cols]).add_suffix("_enc")
